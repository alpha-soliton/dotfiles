...
## following are added jsk install system
## Alias Commands
alias rm='rm -i'
alias cp='cp -i'
alias mv='mv -i'
...
## kengoro install
## ros setting
source ${HOME}/tendon_ws/devel/setup.bash

## tendon setting
export CVSDIR=${HOME}/tendon_ws/src/jsk-ros-pkg
...
export KENSHIROUTIL=${CVSDIR}/jsk_tendon_robot/kenshiro/kenshiro_utils
export KENGOROUTIL=${CVSDIR}/jsk_tendon_robot/kengoro/kengoro_utils
...
if [ -f ${CVSDIR}/jsk_tendon_robot/install/bashrc.tendon ]; then
    source ${CVSDIR}/jsk_tendon_robot/install/bashrc.tendon
fi
...
## Attache tmux
if (! test $TUMX ) && ( ! expr $TERM : "^screen" > /dev/null ) && which tmux > /dev/null; then
...
export CNOID_RTM_DIR=~/catkin_ws/devel
...
#alias ssh='cssh '
#alias ssh=/home/soliton/linux_setup/ssh-change-prompt.sh
alias ssh=/home/soliton/linux_setup/tmux-ssh.sh
